...
typedef struct SimFerroParams{
    ...
    scalar_t M_s = 80.0*22.8*1000.0; //Determined visually from Afkhami 2008.
//    scalar_t M_s = 1923026.4768879882;
    ...
    int const grid_w_em = 32;
    int const grid_h_em = 32;
    int const grid_d_em = 32;

    scalar_t appStrength = 3333;
